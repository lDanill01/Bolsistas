...
urlpatterns = [
    ...
    path('excluidos/', views.EditalProvisorioExcluidosListView.as_view(), name='edital_excluidos'),
    path('excluidos/<int:pk>/restaurar/', views.restaurar_edital, name='edital_restaurar'),
